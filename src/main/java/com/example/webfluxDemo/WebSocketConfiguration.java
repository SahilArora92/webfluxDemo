...
public class WebSocketConfiguration {
    ...
    WebSocketHandler webSocketHandler(ObjectMapper objectMapper, ProfileCreatedEventPublisher eventPublisher){
        ...
        return webSocketSession -> { Flux<WebSocketMessage> messageFlux = publish
            .map(profileCreatedEvent -> {
                try{
                    return objectMapper.writeValueAsString(profileCreatedEvent.getSource());
                }
